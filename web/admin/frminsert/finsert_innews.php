                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            เพิ่มข่าวประชาสัมพันธ์ภายใน
                        </div>
                        <div class="card-body">
                            <form action="../../admin/process/insert_innews.php" method="post" enctype="multipart/form-data">

                                <label for="InNewsName">เรื่อง</label>
                                <input type="text" name="InNewsName" id="InNewsName" required class="form-control"><br>

                                <label for="InNewsDetail">รายละเอียดเพิ่มเติม</label>
                                <textarea name="InNewsDetail" id="InNewsDetail" cols="30" rows="5" required class="form-control"></textarea><br>

                                <div class="mb-3">
                                    <label for="InNewsFile" class="form-label">ไฟล์เอกสาร</label>
                                    <input type="file" class="form-control" id="InNewsFile" name="InNewsFile" required>
                                </div>
